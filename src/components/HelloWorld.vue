<template>
  <div class="hello">
    ...
    = {{ result }}
    <div>
      <button class="calc__btn" @click="calculate('sum')" name="sum">+</button>
      <button class="calc__btn" @click="calculate('sub')" name="sub">-</button>
      <button class="calc__btn" @click="calculate('div')" name="div">/</button>
      <button class="calc__btn" @click="calculate('mul')" name="mul">*</button>
      <button class="calc__btn" @click="calculate('int')" name="int">%</button>
      <button
        class="calc__btn calc__btn-pow"
        @click="calculate('pow')"
        name="pow"
      >
        x<i>y</i>
      </button>
      <button class="calc__btn" @click="calculate('res')" name="res">C</button>
    </div>
    <div>
    ...
    <div class="screen-keyboards" v-show="cheked === true">
      ...
      <button class="screen-keyboards__btn" @click="numberDel" name="del">
        del
      </button>
    </div>
    <div>
